...
public class GapplesHud extends HudElement {
    ...
    public void onRender2D(DrawContext context) {
        ...
        if (factor > 0)
            Render2DEngine.drawBlurredShadow(context, xPos + 22, yPos - 6, 11, 11, 8, Render2DEngine.injectAlpha(new Color(0xFF1500), (int) (255 * factor)));

        FontRenderers.sf_bold_mini.drawCenteredString(context, getItemCount(targetItem) + "", xPos + 28.5f, yPos + 8, -1);
