...
public class BooleanParentComponent extends SettingElement {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float partialTicks) {
        ...
        FontRenderers.modules.drawString(context, getSetting().getName(), (float) getX(), (float) getY() + 5, isHovered() ? -1 : new Color(0xB0FFFFFF, true).getRGB());
        ...
        Render2DEngine.drawRound(context, (float) (x + width - 18), (float) (y + height / 2 - 4), 15, 8, 4, paddingX > 4 ? color : new Color(0xFFB2B1B1));
        Render2DEngine.drawRound(context, (float) (x + width - 17 + paddingX), (float) (y + height / 2 - 3), 6, 6, 3, new Color(-1));
    }
