...
public class BooleanComponent extends SettingElement {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float partialTicks) {
        ...
        Render2DEngine.drawRound(context, x + width - 18, y + height / 2 - 4, 15, 8, 4, paddingX > 4 ? color : new Color(0xFFB2B1B1));
        Render2DEngine.drawRound(context, (float) (x + width - 17 + paddingX), y + height / 2 - 3, 6, 6, 3, new Color(-1));
    }
