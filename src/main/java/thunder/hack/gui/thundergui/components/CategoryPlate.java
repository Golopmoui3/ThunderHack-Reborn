...
public class CategoryPlate {
    ...
    public void render(DrawContext context, int MouseX, int MouseY) {
        ...
        if (isHovered(MouseX, MouseY)) {
            Render2DEngine.drawRound(context, posX, posY, 84, 15, 2f, new Color(25, 20, 30, (int) MathUtility.clamp(65 * category_animation, 0, 255)));
            Render2DEngine.drawBlurredShadow(context, MouseX - 20, MouseY - 20, 40, 40, 60, new Color(0xC3555A7E, true));
        }
        FontRenderers.modules.drawString(context, cat.getName(), posX + 5, posY + 6, -1);
