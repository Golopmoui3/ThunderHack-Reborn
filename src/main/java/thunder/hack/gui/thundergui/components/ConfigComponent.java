...
public class ConfigComponent {
    ...
    public void render(DrawContext context, int MouseX, int MouseY) {
        ...
        if (Managers.CONFIG.currentConfig.getName().equals(name + ".th")) {
            Render2DEngine.drawGradientRound(context, posX + 5, posY, 285, 30, 4f,
            ...
            Render2DEngine.drawRound(context, posX + 5, posY, 285, 30, 4f, Render2DEngine.applyOpacity(new Color(44, 35, 52, 255), getFadeFactor()));
        ...
        if (Render2DEngine.isHovered(MouseX, MouseY, posX + 252, posY + 10, 10, 10)) {
            Render2DEngine.drawRound(context, posX + 252, posY + 10, 10, 10, 2f, Render2DEngine.applyOpacity(new Color(21, 58, 0, 255), getFadeFactor()));
        } else
            Render2DEngine.drawRound(context, posX + 252, posY + 10, 10, 10, 2f, Render2DEngine.applyOpacity(new Color(32, 89, 0, 255), getFadeFactor()));

        if (Render2DEngine.isHovered(MouseX, MouseY, posX + 268, posY + 10, 10, 10)) {
            Render2DEngine.drawRound(context, posX + 268, posY + 10, 10, 10, 2f, Render2DEngine.applyOpacity(new Color(65, 1, 13, 255), getFadeFactor()));
        } else
            Render2DEngine.drawRound(context, posX + 268, posY + 10, 10, 10, 2f, Render2DEngine.applyOpacity(new Color(94, 1, 18, 255), getFadeFactor()));

        FontRenderers.icons.drawString(context, "x", posX + 252, posY + 13, Render2DEngine.applyOpacity(-1, getFadeFactor()));
        FontRenderers.icons.drawString(context, "w", posX + 268, posY + 13, Render2DEngine.applyOpacity(-1, getFadeFactor()));


        FontRenderers.mid_icons.drawString(context, "u", posX + 7, posY + 5, Render2DEngine.applyOpacity(-1, getFadeFactor()));
        FontRenderers.modules.drawString(context, name, posX + 37, posY + 6, Render2DEngine.applyOpacity(-1, getFadeFactor()));
        FontRenderers.settings.drawString(context, "updated on: " + date, posX + 37, posY + 17, Render2DEngine.applyOpacity(new Color(0xFFBDBDBD, true).getRGB(), getFadeFactor()));
    }
