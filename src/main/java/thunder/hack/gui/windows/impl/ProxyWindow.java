...
public class ProxyWindow extends WindowBase {
    ...
    public void render(DrawContext context, int mouseX, int mouseY) {
...

        {
            ...
            Render2DEngine.drawRectWithOutline(context, ipX, getY() + 19, posXWidth, 11, hover3 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, addIp + (listeningId == -3 && listeningType == ListeningType.Ip ? blink : "")
                    , ipX + 2, getY() + 23, textColor);

            boolean hover4 = Render2DEngine.isHovered(mouseX, mouseY, portX, getY() + 19, posYWidth, 11);
            Render2DEngine.drawRectWithOutline(context, portX, getY() + 19, posYWidth, 11, hover4 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, addPort + (listeningId == -3 && listeningType == ListeningType.Port ? blink : "")
            ...
            FontRenderers.sf_medium.drawString(context, addLogin + (listeningId == -3 && listeningType == ListeningType.Login ? blink : "")
            ...
            FontRenderers.sf_medium.drawString(context, addPassword + (listeningId == -3 && listeningType == ListeningType.Password ? blink : "")
        ...
        FontRenderers.sf_medium.drawCenteredString(context, "IP", ipX + posXWidth / 2f, getY() + 40, textColor);
        FontRenderers.sf_medium.drawCenteredString(context, "Port", portX + posYWidth / 2f, getY() + 40, textColor);
        FontRenderers.sf_medium.drawCenteredString(context, "Login", posZX + posZWidth / 2f, getY() + 40, textColor);
        FontRenderers.sf_medium.drawCenteredString(context, "Password", serverX + serverWidth / 2f, getY() + 40, textColor);
        ...
        for (ProxyPlate proxyPlate : proxyPlates) {
            ...
            Render2DEngine.drawRectWithOutline(context, nameX, getY() + 36 + getScrollOffset() + proxyPlate.offset, nameWidth, 11, hover2 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, proxyPlate.proxy.getName() + (listeningId == proxyPlate.id && listeningType == ListeningType.Name ? blink : "")
            ...
            Render2DEngine.drawRectWithOutline(context, ipX, getY() + 36 + getScrollOffset() + proxyPlate.offset, posXWidth, 11, hover3 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, proxyPlate.proxy.getIp() + (listeningId == proxyPlate.id && listeningType == ListeningType.Ip ? blink : "")
            ...
            Render2DEngine.drawRectWithOutline(context, portX, getY() + 36 + getScrollOffset() + proxyPlate.offset, posYWidth, 11, hover4 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, proxyPlate.proxy.getPort() + (listeningId == proxyPlate.id && listeningType == ListeningType.Port ? blink : "")
            ...
            Render2DEngine.drawRectWithOutline(context, posZX, getY() + 36 + getScrollOffset() + proxyPlate.offset, posZWidth, 11, hover5 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, hover5 ? (proxyPlate.proxy.getL() + (listeningId == proxyPlate.id && listeningType == ListeningType.Login ? blink : "")) : "*******"
            ...
            Render2DEngine.drawRectWithOutline(context, serverX, getY() + 36 + getScrollOffset() + proxyPlate.offset, serverWidth, 11, hover6 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, hover6 ? (proxyPlate.proxy.getP() + (listeningId == proxyPlate.id && listeningType == ListeningType.Password ? blink : "")) : "*******"
            ...
            Render2DEngine.drawRectWithOutline(context, getX() + getWidth() - 15, getY() + 36 + getScrollOffset() + proxyPlate.offset, 11, 11, hover8 ? hoveredColor : color, color2);
            FontRenderers.icons.drawString(context, "w", getX() + getWidth() - 15, proxyPlate.offset + getY() + 40 + getScrollOffset(), -1);
            FontRenderers.sf_medium_mini.drawString(context, id + ".", getX() + 3, getY() + 41 + getScrollOffset() + proxyPlate.offset, textColor);
            ...
            Render2DEngine.drawRectWithOutline(context, getX() + getWidth() - 28, getY() + 36 + getScrollOffset() + proxyPlate.offset, 11, 11, hover9 ? hoveredColor : color, color2);
            FontRenderers.icons.drawString(context, selected ? "i" : "k", getX() + getWidth() - 26, proxyPlate.offset + getY() + 41 + getScrollOffset(), selected ? -1 : Color.GRAY.getRGB());
            ...
            Render2DEngine.drawRectWithOutline(context, getX() + getWidth() - 51.5f, getY() + 36 + getScrollOffset() + proxyPlate.offset, 21.5f, 11, hover10 ? hoveredColor : color, color2);
