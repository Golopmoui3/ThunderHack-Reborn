...
public class FriendsWindow extends WindowBase {
    ...
    public void render(DrawContext context, int mouseX, int mouseY) {
        ...
        for (FriendPlate friendPlate : friendPlates) {
            ...
            FontRenderers.sf_medium.drawString(context, friendPlate.name() + (online ? Formatting.DARK_GRAY + " l " + Formatting.GREEN + "Online" : ""), getX() + 13, friendPlate.offset + getY() + 40 + getScrollOffset(), textColor);

            // Delete
            boolean hover5 = Render2DEngine.isHovered(mouseX, mouseY, getX() + getWidth() - 15, friendPlate.offset + getY() + 36 + getScrollOffset(), 11, 11);
            Render2DEngine.drawRectWithOutline(context, getX() + getWidth() - 15, friendPlate.offset + getY() + 36 + getScrollOffset(), 11, 11, hover5 ? hoveredColor : color, color2);
            FontRenderers.icons.drawString(context, "w", getX() + getWidth() - 15, friendPlate.offset + getY() + 40 + getScrollOffset(), -1);
