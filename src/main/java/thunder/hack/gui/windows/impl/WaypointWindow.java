...
public class WaypointWindow extends WindowBase {
    ...
    public void render(DrawContext context, int mouseX, int mouseY) {
...

        {
            ...
            Render2DEngine.drawRectWithOutline(context, posXX, getY() + 19, posXWidth, 11, hover3 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, addX + (listeningId == -3 && listeningType == ListeningType.X ? blink : "")
                    , posXX + 2, getY() + 23, textColor);

            // Y
            boolean hover4 = Render2DEngine.isHovered(mouseX, mouseY, posYX, getY() + 19, posYWidth, 11);
            Render2DEngine.drawRectWithOutline(context, posYX, getY() + 19, posYWidth, 11, hover4 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, addY + (listeningId == -3 && listeningType == ListeningType.Y ? blink : "")
            ...
            Render2DEngine.drawRectWithOutline(context, posZX, getY() + 19, posZWidth, 11, hover5 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, addZ + (listeningId == -3 && listeningType == ListeningType.Z ? blink : "")
            ...
            Render2DEngine.drawRectWithOutline(context, serverX, getY() + 19, serverWidth, 11, hover6 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, addServer + (listeningId == -3 && listeningType == ListeningType.Server ? blink : "")
            ...
            Render2DEngine.drawRectWithOutline(context, dimensionX, getY() + 19, dimensionWidth, 11, hover7 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, addDimension, dimensionX + 2, getY() + 23, new Color(0xBDBDBD).getRGB());

            // Add
            boolean hover8 = Render2DEngine.isHovered(mouseX, mouseY, getX() + getWidth() - 15, getY() + 19, 11, 11);
            Render2DEngine.drawRectWithOutline(context, getX() + getWidth() - 15, getY() + 19, 11, 11, hover8 ? hoveredColor : color, color2);
        ...
        FontRenderers.sf_medium.drawCenteredString(context, "X", posXX + posXWidth / 2f, getY() + 40, textColor);
        FontRenderers.sf_medium.drawCenteredString(context, "Y", posYX + posYWidth / 2f, getY() + 40, textColor);
        FontRenderers.sf_medium.drawCenteredString(context, "Z", posZX + posZWidth / 2f, getY() + 40, textColor);
        FontRenderers.sf_medium.drawCenteredString(context, "Server", serverX + serverWidth / 2f, getY() + 40, textColor);
        FontRenderers.sf_medium.drawCenteredString(context, "Dimension", dimensionX + dimensionWidth / 2f, getY() + 40, textColor);
        ...
        for (WaypointPlate waypointPlate : waypointPlates) {
            ...
            Render2DEngine.drawRectWithOutline(context, nameX, getY() + 36 + getScrollOffset() + waypointPlate.offset, nameWidth, 11, hover2 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, waypointPlate.waypoint.getName() + (listeningId == waypointPlate.id && listeningType == ListeningType.Name ? blink : "")
            ...
            Render2DEngine.drawRectWithOutline(context, posXX, getY() + 36 + getScrollOffset() + waypointPlate.offset, posXWidth, 11, hover3 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, waypointPlate.waypoint.getX() + (listeningId == waypointPlate.id && listeningType == ListeningType.X ? blink : "")
            ...
            Render2DEngine.drawRectWithOutline(context, posYX, getY() + 36 + getScrollOffset() + waypointPlate.offset, posYWidth, 11, hover4 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, waypointPlate.waypoint.getY() + (listeningId == waypointPlate.id && listeningType == ListeningType.Y ? blink : "")
            ...
            Render2DEngine.drawRectWithOutline(context, posZX, getY() + 36 + getScrollOffset() + waypointPlate.offset, posZWidth, 11, hover5 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, waypointPlate.waypoint.getZ() + (listeningId == waypointPlate.id && listeningType == ListeningType.Z ? blink : "")
            ...
            Render2DEngine.drawRectWithOutline(context, serverX, getY() + 36 + getScrollOffset() + waypointPlate.offset, serverWidth, 11, hover6 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, waypointPlate.waypoint.getServer() + (listeningId == waypointPlate.id && listeningType == ListeningType.Server ? blink : "")
            ...
            Render2DEngine.drawRectWithOutline(context, dimensionX, getY() + 36 + getScrollOffset() + waypointPlate.offset, dimensionWidth, 11, hover7 ? hoveredColor : color, color2);
            FontRenderers.sf_medium.drawString(context, waypointPlate.waypoint.getDimension(), dimensionX + 2, getY() + 40 + getScrollOffset() + waypointPlate.offset, new Color(0xBDBDBD).getRGB());
            ...
            Render2DEngine.drawRectWithOutline(context, getX() + getWidth() - 15, getY() + 36 + getScrollOffset() + waypointPlate.offset, 11, 11, hover8 ? hoveredColor : color, color2);
            FontRenderers.icons.drawString(context, "w", getX() + getWidth() - 15, waypointPlate.offset + getY() + 40 + getScrollOffset(), -1);
