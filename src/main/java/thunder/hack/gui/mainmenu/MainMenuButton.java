...
public class MainMenuButton {
    ...
    public void onRender(DrawContext context, float mouseX, float mouseY) {
        ...
        FontRenderers.monsterrat.drawCenteredString(context, name, halfOfWidth + posX + width / 2f, halfOfHeight + posY + height / 2f - 3f, hovered ? -1 : Render2DEngine.applyOpacity(-1, 0.7f));
    }
